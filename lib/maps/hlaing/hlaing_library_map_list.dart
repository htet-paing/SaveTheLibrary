...
class HlaingPointApp extends StatefulWidget {
  @override
  HlaingPointAppState createState() => HlaingPointAppState();
}

class HlaingPointAppState extends State<HlaingPointApp> {
  ...
  // Hlaing Township Library Codes here 
  // Commented by ak1337
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: _boxes(
                  "https://savethelibrarymyanmar.org/media/710/conversions/feature_image.jpg",
                  16.8479, 96.1252, "Rangon Reading Club"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: _boxes(
                  "https://savethelibrarymyanmar.org/media/65/conversions/feature_image.jpg",
                  16.85000000, 96.12000000, "Happy Childs Library"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: _boxes(
                  "https://savethelibrarymyanmar.org/media/132/conversions/feature_image.jpg",
                  16.8479, 96.1252, "Mandalay Library"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: _boxes(
                  ...
                  16.8479, 96.1252, "A Lin Thit Library"),
            ),
  ...
  Widget _buildGoogleMap(BuildContext context) {
    return Container(
      ...
      child: GoogleMap(
        ...
        initialCameraPosition: CameraPosition(target: LatLng(16.845267, 96.1094473), zoom: 16),
