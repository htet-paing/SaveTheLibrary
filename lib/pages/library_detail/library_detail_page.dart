...
Future<void> _minus(double zoomVal) async {
  ...
  controller.animateCamera(CameraUpdate.newCameraPosition(
      CameraPosition(target: LatLng(16.9101878, 96.0118898), zoom: zoomVal)));
}
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: _boxes(
                ...
                16.8102,
                96.1765,
                "Kyauk Myaung Yap Sar Phat A Thin"),
          ),
          SizedBox(width: 10.0),
          Padding(
            padding: const EdgeInsets.all(8.0),
  ...
  return Container(
    ...
    child: GoogleMap(
      ...
      initialCameraPosition:
          CameraPosition(target: LatLng(16.8091028, 96.1629651), zoom: 16),
