...
import 'package:save_the_library/pages/developers/network_image.dart';
import 'package:url_launcher/url_launcher.dart';
  
import 'package:flutter/material.dart';

class ProfileSixPage extends StatelessWidget {
  // static final String path = "lib/pages/developers/information.dart";
...
final DEV sid = DEV(
  ...
  biography: 'Soe thiha naung is a mobile and web app dev but also teacher. '
      'He loves to teach the students in his Myanmar Links Class./n'
   'Video Lessons',
  videos: <Video>[
    Video(
      title: 'App State in Flutter',
      thumbnail: sidVideoThumbs[0],
      url: 'https://www.youtube.com/watch?v=gQQUH08OS7c&t=287s',
    ),
    Video(
      title: 'Flutter Stateful and Stateless Widget Intro',
      thumbnail: sidVideoThumbs[1],
      url: 'https://www.youtube.com/watch?v=XUylqu0REw0',
    ),
    Video(
      title: 'Vue and Laravel combination',
      thumbnail: sidVideoThumbs[2],
      url: 'https://www.youtube.com/watch?v=VsNkJ7DFLJQ',
    ),
    Video(
      title: 'How Start to Learn PHP',
      thumbnail: sidVideoThumbs[3],
      url: 'https://www.youtube.com/watch?v=CbSgEEtFaEw',
    ),
  ],
);