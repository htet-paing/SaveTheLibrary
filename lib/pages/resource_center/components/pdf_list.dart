  ...
  Widget build(BuildContext context) {
    return Consumer2<ResourceCenterModel, ApiService>(
      builder: (context, resourceCenterModel, apiService, _) {
        return SmartList<BuiltPdfList>(
          items: resourceCenterModel.pdfList,
          onLoaded: (body) {
            resourceCenterModel.setPdfList(
              resourceCenterModel.pdfList + List.from(body.data),
            );
          },
          onGet: (page) => apiService.getPdfs(page),
